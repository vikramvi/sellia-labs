...
exports.getQueriesForDocumentsAround = getQueriesForDocumentsAround;
exports.getNearestDocs = getNearestDocs;
...
var g_GEOHASH_PRECISION = 10; // Characters used in location geohashes

var g_BASE32 = '0123456789bcdefghjkmnpqrstuvwxyz'; // The meridional circumference of the earth in meters

var g_EARTH_MERI_CIRCUMFERENCE = 40007860; // Length of a degree latitude at the equator

var g_METERS_PER_DEGREE_LATITUDE = 110574; // Number of bits per geohash character

var g_BITS_PER_CHAR = 5; // Maximum length of a geohash in bits

var g_MAXIMUM_BITS_PRECISION = 22 * g_BITS_PER_CHAR; // Equatorial radius of the earth in meters

var g_EARTH_EQ_RADIUS = 6378137.0; // The following value assumes a polar radius of
...
var g_E2 = 0.00669447819799; // Cutoff for rounding errors on double calculations
...
var validateGeohash = function validateGeohash(geohash) {
  var error;
...
var validateCriteria = function validateCriteria(newQueryCriteria, requireCenterAndRadius) {
  if ((0, _typeof2["default"])(newQueryCriteria) !== 'object') {
...
var encodeGeohash = function encodeGeohash(location, precision) {
...
var metersToLongitudeDegrees = function metersToLongitudeDegrees(distance, latitude) {
...
var longitudeBitsForResolution = function longitudeBitsForResolution(resolution, latitude) {
...
var latitudeBitsForResolution = function latitudeBitsForResolution(resolution) {
...
var wrapLongitude = function wrapLongitude(longitude) {
...
var boundingBoxBits = function boundingBoxBits(coordinate, size) {
...
var boundingBoxCoordinates = function boundingBoxCoordinates(center, radius) {
...
var geohashQuery = function geohashQuery(geohash, bits) {
...
var geohashQueries = function geohashQueries(center, radius) {
...
var distance = function distance(location1, location2) {
...
function getNearestDocs(_x, _x2) {
  return _getNearestDocs.apply(this, arguments);
}

function _getNearestDocs() {
  _getNearestDocs = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(collection, center) {
    var MAX_DISTANCE,
        resultCount,
        totalDistanceKm,
        matchCount,
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            MAX_DISTANCE = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 100;
            resultCount = 0, totalDistanceKm = 0, matchCount = 0, matchDistanceKm = 0, maxDistanceKm = 0;
            docs = {};
            nearest = [];
            queries = getQueriesForDocumentsAround(collection, center, MAX_DISTANCE);
            return _context2.abrupt("return", Promise.all(queries.map(function (query) {
                      ...
                      switch (_context.prev = _context.next) {
                        ...
                        case 2:
                          ...
                          snap.forEach(function (doc) {
                            ...
                            nearest.push(_objectSpread(_objectSpread({}, doc.data()), {}, {
                              id: doc.id,
                              distance: dist
                            }));
                          });
